...
function UsersActive(props) {
    const { usersActive, setModalTitle, setIsVisibleModal, setModalContent, setReloadUsers } = props;
    const editUser = user => 
    {
        ...
        if (user.name)
            ...
            setModalTitle("Editando usuario ...");
    ...
    return (
        <List.Item
            actions={[
                <Button
                    type="primary"   
                    onClick={() => console.log("Activar Usuaario")}>
                    <Icon type="check"/>
                </Button>,
                <Button
                    type="danger"   
